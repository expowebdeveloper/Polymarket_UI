...
export const getStreakBadge = (streak: number): StreakBadge | null => {
    if (streak >= 30) return {
        ...
        tooltip: 'Legendary Streak (≥30) → 30+ consecutive wins',
    };
    if (streak >= 20) return {
