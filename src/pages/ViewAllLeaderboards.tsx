            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-slate-800 rounded-lg p-4 mb-6 border border-slate-700">
                    <div className="flex flex-wrap gap-2 mb-4">
                        ...
                        <button
                            onClick={() => setActiveTab('final_score')}
                            className={`px-4 py-2 rounded ${activeTab === 'final_score' ? 'bg-yellow-600 text-white' : 'bg-slate-700 text-slate-300 hover:bg-slate-600'}`}
                        >
                            Final Score
                        </button>
                    </div>
                        ...
                        <table className="w-full border-collapse">
                            <thead>
                                <tr className="bg-slate-900">
                                    ...
                                    <th className="border border-slate-700 px-4 py-2 text-right">Final_Score</th>
                                </tr>
                            </thead>
                            <tbody>
                                {currentLeaderboard.slice(0, 100).map((entry, index) => (
                                    <tr key={entry.wallet_address || index} className="hover:bg-slate-700">
                                        ...
                                        <td className="border border-slate-700 px-4 py-2 text-right font-bold text-yellow-400">
